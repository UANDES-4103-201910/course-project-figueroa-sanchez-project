...
class ProfilePhotosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profile_photo" do
    assert_difference('ProfilePhoto.count') do
      post profile_photos_url, params: { profile_photo: { photo_link: @profile_photo.photo_link, profile: @profile_photo.profile } }
    end
  ...
  test "should update profile_photo" do
    patch profile_photo_url(@profile_photo), params: { profile_photo: { photo_link: @profile_photo.photo_link, profile: @profile_photo.profile } }
