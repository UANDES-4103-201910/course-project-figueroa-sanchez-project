...
class FollowPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow_post" do
    assert_difference('FollowPost.count') do
      post follow_posts_url, params: { follow_post: { post: @follow_post.post, user: @follow_post.user } }
    end
  ...
  test "should update follow_post" do
    patch follow_post_url(@follow_post), params: { follow_post: { post: @follow_post.post, user: @follow_post.user } }
