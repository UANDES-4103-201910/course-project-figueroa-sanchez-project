...
class UserPasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_password" do
    assert_difference('UserPassword.count') do
      post user_passwords_url, params: { user_password: { password: @user_password.password, user: @user_password.user } }
    end
  ...
  test "should update user_password" do
    patch user_password_url(@user_password), params: { user_password: { password: @user_password.password, user: @user_password.user } }
