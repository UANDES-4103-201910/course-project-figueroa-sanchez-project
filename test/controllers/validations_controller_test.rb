...
class ValidationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create validation" do
    assert_difference('Validation.count') do
      post validations_url, params: { validation: { post: @validation.post, user: @validation.user, vote: @validation.vote } }
    end
  ...
  test "should update validation" do
    patch validation_url(@validation), params: { validation: { post: @validation.post, user: @validation.user, vote: @validation.vote } }
